  ...
  return (
    <div className="justify-center bg-gray-100 sm:flex sm:space-x-6 sm:px-1 lg:pl-60 lg:pr-64">
      ...
      <div className="flex hidden basis-1/4 flex-col space-y-1 py-4 pl-4 sm:block lg:mt-4">
        <button className="flex w-full items-center space-x-2 rounded-md bg-white py-1 pl-2 pr-10 font-bold text-gray-700 hover:text-indigo-700">
          <span className="text-xl">😊</span>
          <span>Profile</span>
        </button>
        <button className="flex w-full items-center space-x-2 rounded-md py-1 pl-2 pr-10 text-gray-700 hover:bg-indigo-100 hover:text-indigo-700">
      ...
      <div className="flex min-h-screen basis-3/4 flex-col justify-center sm:w-3/4 lg:mt-3">
        <div className="relative my-3 block sm:hidden" ref={dropdownRef}>
          <button
            ...
            className="mx-2 w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-left text-gray-700 hover:border-2 hover:border-indigo-700 focus:outline-none"
          >
            Profile
            <span className="float-right">&#9662;</span> {/* Down arrow */}
          </button>
          {isOpen && (
            <div className="absolute mx-2 mt-1 w-full rounded-md border border-gray-300 bg-white">
